    ...
    rows.forEach(element => {
      ...
      if(counter % 4 == 0 || counter == 0) {
        ...
        if(kategorija == '20') {
          ...
          popust_container.append(popust_1)
          if(kategorija == '3') {
            var loyalty_slika = document.createElement('img')
            loyalty_slika.setAttribute('class', 'loyalty-slika')
            loyalty_slika.setAttribute('src', 'https://maxi.sales-snap.com/asset/2782:mojmaxiloyaltyapppng')
            // console.log(loyalty_slika)
            popust_container.append(loyalty_slika)
          } 
        ...
        //   outer_cell.append(cell)
          ...
          if(counter == 24) {
            ...
            njuzleter.setAttribute('src', 'https://maxi.sales-snap.com/form/generate.js?id=7')
            ...
            // var row_id = 'promo-banner'
            // tabela_row.setAttribute('id', row_id)
            tabela_row.innerHTML = '<div class="proizvodi-cell single-image"><a href="javascript:void(0)" onclick="getMobileOperatingSystem()"><img src="https://maxi.sales-snap.com/asset/2781:mojmaxi-1376x430png" class="promo-banner" ></a></div>'
            document.getElementById('tabela-proizvoda').append(tabela_row)
          }
        }
...
async function getImage() {
  ...
  rows.forEach(element => {
    ...
    $('[id="' + sifra_artikla + '"] img:not(.loyalty-slika)').attr('src', src)
...
function addFavorite() {
        for(var x = 0; x < $('.tabela-proizvoda-div[style*="block"] .cekboks-kalkulatora').length; x++) {
          ...
          if($('.tabela-proizvoda-div[style*="block"] .cekboks-kalkulatora:eq(' + x + ')')[0].checked == true) {
              ...
              var value = $('.tabela-proizvoda-div[style*="block"] .cekboks-kalkulatora:eq(' + x + ')').parents('.spoljni-div').attr('id')
            //   console.log('1')
